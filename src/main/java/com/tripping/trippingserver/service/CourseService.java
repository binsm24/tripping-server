...
public class CourseService {
    ...
    private CourseResponse createTemporaryCourseResponse() {
        return CourseResponse.builder()
                ...
                .places(List.of(
                        CoursePlaceResponse.builder()
                                ...
                                .name("안목해변")
                                .summary(
                                        "푸른 바다를 바라보며 산책하기 좋은 해변입니다."
                                )
                                .imageUrl(
                                        "https://example.com/anmok.jpg"
                                )
                                .latitude(37.751853)
                        ...
                        CoursePlaceResponse.builder()
                                ...
                                .name("테라로사")
                                .summary(
                                        "감성적인 분위기의 스페셜티 카페입니다."
                                )
                                .imageUrl(
                                        "https://example.com/terarosa.jpg"
                                )
                                .latitude(37.7225)
                                .longitude(128.9304)
                                .build(),
